    ...
    <section className="py-12">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          viewport={{ once: true }}
          className="card-fifa rounded-2xl p-8 text-center fifa-pattern glow-cyan animate-pulse-glow"
        >
          <div className="relative z-10">
            <h2 className="font-heading text-xl md:text-2xl font-bold mb-2 uppercase tracking-wider">
              ¿Listo para forjar tu <span className="text-gradient">disciplina</span>?
            </h2>
